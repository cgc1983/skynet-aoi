...
local function launch_slave(auth_handler)
    skynet.error("launch_slave auth_handler run")
	local function auth(fd, addr)
        skynet.error("launch_slave auth run")
        ...
        skynet.error("clientkey =", clientkey)
		if #clientkey ~= 8 then
...
local function login(conf)
    ...
    skynet.error("login name=",name)
	skynet.start(function()
		local loginmaster = skynet.localname(name)
        skynet.error("loginmaster name=",loginmaster)
		if loginmaster then
